...
log_file_path = os.path.join(script_dir, "unity_code_mcp_bridge_over_file.log")

logger = logging.getLogger("unity-code-mcp-stdio-over-file")
...
def create_server(unity_client: UnityBridgeClient) -> Server:
    ...
    server = Server("unity-code-mcp-stdio-over-file")
